...
export type SlotMachine = {
  ...
  methods:
    ...
    & Record<'get_block_seed(uint64)byte[32]' | 'get_block_seed', {
      argsObj: {
        round: bigint | number
      }
      argsTuple: [round: bigint | number]
      returns: Uint8Array
    }>
    ...
    & Record<'get_max_bet()uint64' | 'get_max_bet', {
      argsObj: {
      }
      argsTuple: []
      returns: bigint
    ...
    & Record<'spin(uint64,uint64,uint64)byte[56]' | 'spin', {
      argsObj: {
        ...
        /**
         * Used to determine which 8 bytes of the block seed to use.
         */
        index: bigint | number
        futureRoundOffset: bigint | number
      }
      argsTuple: [betAmount: bigint | number, index: bigint | number, futureRoundOffset: bigint | number]
      /**
  ...
  state: {
    global: {
      ...
      baseHouseEdgeBps?: IntegerState
      contractVersion?: IntegerState
      deploymentVersion?: IntegerState
      maxHouseEdgeBps?: IntegerState
      minBetAmount?: IntegerState
      minHouseEdgeBps?: IntegerState
      owner?: BinaryState
...
export abstract class SlotMachineCallFactory {
  ...
  /**
   * Constructs a no op call for the get_block_seed(uint64)byte[32] ABI method
   *
   * @param args Any args for the contract call
   * @param params Any additional parameters for the call
   * @returns A TypedCallParams object for the call
   */
  static getBlockSeed(args: MethodArgs<'get_block_seed(uint64)byte[32]'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      method: 'get_block_seed(uint64)byte[32]' as const,
      methodArgs: Array.isArray(args) ? args : [args.round],
      ...params,
    }
  }
  /**
...
Only callable by contract owner
  ...
  /**
   * Constructs a no op call for the get_max_bet()uint64 ABI method
   *
   ...
   * @returns A TypedCallParams object for the call
   */
  static getMaxBet(args: MethodArgs<'get_max_bet()uint64'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      method: 'get_max_bet()uint64' as const,
      methodArgs: Array.isArray(args) ? args : [],
      ...params,
    }
  }
...
of future round.
  ...
  static spin(args: MethodArgs<'spin(uint64,uint64,uint64)byte[56]'>, params: AppClientCallCoreParams & CoreAppCallArgs) {
    return {
      ...
      methodArgs: Array.isArray(args) ? args : [args.betAmount, args.index, args.futureRoundOffset],
      ...params,
    }
  }
  /**
...
export class SlotMachineClient {
  ...
  /**
   * Calls the get_block_seed(uint64)byte[32] ABI method.
   *
   * @param args The arguments for the contract call
   * @param params Any additional parameters for the call
   * @returns The result of the call
   */
  public getBlockSeed(args: MethodArgs<'get_block_seed(uint64)byte[32]'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
    return this.call(SlotMachineCallFactory.getBlockSeed(args, params))
  }
...
Only callable by contract owner
  ...
  /**
   * Calls the get_max_bet()uint64 ABI method.
   *
   * Get the maximum bet amount
   *
   * @param args The arguments for the contract call
   ...
   * @returns The result of the call
   */
  public getMaxBet(args: MethodArgs<'get_max_bet()uint64'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
    return this.call(SlotMachineCallFactory.getMaxBet(args, params))
  }
...
of future round.
  ...
  public async getGlobalState(): Promise<SlotMachine['state']['global']> {
    ...
    return {
      ...
      get baseHouseEdgeBps() {
        return SlotMachineClient.getIntegerState(state, 'base_house_edge_bps')
      },
      get contractVersion() {
      ...
      get maxHouseEdgeBps() {
        return SlotMachineClient.getIntegerState(state, 'max_house_edge_bps')
      },
      get minBetAmount() {
        return SlotMachineClient.getIntegerState(state, 'min_bet_amount')
      },
      get minHouseEdgeBps() {
        return SlotMachineClient.getIntegerState(state, 'min_house_edge_bps')
      },
      get owner() {
  ...
  public compose(): SlotMachineComposer {
    ...
    return {
      ...
      getBlockSeed(args: MethodArgs<'get_block_seed(uint64)byte[32]'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
        promiseChain = promiseChain.then(() => client.getBlockSeed(args, {...params, sendParams: {...params?.sendParams, skipSending: true, atc}}))
        resultMappers.push(undefined)
        return this
      },
      ...
      getMaxBet(args: MethodArgs<'get_max_bet()uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs) {
        promiseChain = promiseChain.then(() => client.getMaxBet(args, {...params, sendParams: {...params?.sendParams, skipSending: true, atc}}))
        resultMappers.push(undefined)
        return this
      },
...
export type SlotMachineComposer<TReturns extends [...any[]] = []> = {
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  getBlockSeed(args: MethodArgs<'get_block_seed(uint64)byte[32]'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SlotMachineComposer<[...TReturns, MethodReturn<'get_block_seed(uint64)byte[32]'>]>
...
Only callable by contract owner
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  getMaxBet(args: MethodArgs<'get_max_bet()uint64'>, params?: AppClientComposeCallCoreParams & CoreAppCallArgs): SlotMachineComposer<[...TReturns, MethodReturn<'get_max_bet()uint64'>]>
